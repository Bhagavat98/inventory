...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg" style="font-size: 24px;">Change your password</p>

    <form action="{{ url('passwordChange') }}" method="post">
        @csrf
		  <div class="form-group has-feedback">
          <label for="new_password" >New Password</label>
          <input type="password" class="form-control" placeholder="Enter Password" name="new_password" id="new_password" required>
          <span class="fa fa-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
          <label for="password_conform">Confirm New Password</label>
          <input type="password" class="form-control" placeholder="Re-enter Password" name="password_conform" id="password_conform" required>
          <span class="fa fa-lock form-control-feedback"></span>
      </div>
      <div class="row">
